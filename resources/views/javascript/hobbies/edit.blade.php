        ...
        <div class="p-6">
            <form id="editForm" method="POST" action="" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="editName" name="name" class="h-10 text-lg mt-1 block w-full rounded-md border-gray-300 dark:bg-slate-200 shadow-sm focus:ring-blue-500 focus:border-blue-500" placeholder="Enter hobby name" required>
                </div>
